...
img = mpimg.imread('/content/image_shaped/00ab26d4-71a6-4185-970f-e03166ad10ae.jpeg')
imgplt = plt.imshow(img)
plt.show()

# creaing a for loop to assign labels
filenames = os.listdir('/content/image_shaped/')
...
import cv2
import glob
image_directory = '/content/image_reshaped/'
...
if input_pred_label == 0:
  print('This represents a Celosa')
else:
  if input_pred_label == 1:
    print('This represents a Chloris')
  else:
    print('This repsents a Crowfoot ')
